...
\end{align}
Dans la phase désordonnée, où $m^2 \less 0$ et $\lambda \neq 0$, l'approximation gaussienne du modèle $\phi^4$ donne le même résultat que \ref{fonction-correl} avec le facteur $m^2$ renormalisé par l'équation auto-consistante
\begin{align}
...
\end{align}
où $D$ est le coefficient de diffusion de l'interface, $\nu$ le flux d'aggrégation de particules sur l'interface et $\tilde{\eta}(x,t)$ est un bruit blanc de moyenne nulle défini par
\begin{align}
