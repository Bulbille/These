...
\newcommand\BackgroundPic{
	\put(0,0){%
      ...
      \includegraphics[height=150pt]{cnrs.png}
      \hfill
      \includegraphics[height=110pt]{logo_ENS.jpg}      
		}
	}
}
...
\AddToShipoutPicture*{\EtiquetteThese}
  \begin{titlepage}
  \centering
      \includegraphics[height=50pt]{anr.png}
      \hfill 
      \includegraphics[height=50pt]{loma.png}      
      \hfill
      \includegraphics[height=50pt]{u-bordeaux.png}    \\         
    \vspace{1cm}
      {\Large École doctorale 209 : Sciences physiques et de l'ingénieur}\\
    \vspace{1cm}
      {\huge 
      	TH\`{E}SE}\\
    \vspace{1cm}
	...
	\textbf{Université de Bordeaux \\
	Laboratoire Onde Matière d'Aquitaine \\
